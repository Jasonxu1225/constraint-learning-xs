...
class OnPolicyWithCostAlgorithm(BaseAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if 'method' in self.policy_kwargs:
            policy_kwargs_add = {'input_action': self.input_action}
            self.policy_kwargs.update(**policy_kwargs_add)
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            rollout_buffer.add(self._last_obs, self._last_original_obs, new_obs, orig_obs, actions, new_actions,
